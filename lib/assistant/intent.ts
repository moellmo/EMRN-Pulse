...
export function isProductDetailIntent(text: string) {
  ...
  return isProductCapabilityIntent(text) || /\b(how\s+big|how\s+large|how\s+long|how\s+much|how\s+many|who\s+makes|who\s+sells|sold\s+by|manufacturer|brand|what\s+colors?|what\s+colours?|what\s+sizes?|price|cost|compatible|compatibility|fit|fits|work with|works with|go with|goes with|hold|holds|holding|carry|carries|carrying|accommodate|accommodates|oxygen tank|oxygen cylinder|o2 tank|o2 cylinder|for this|for that|replacement part|replacement parts|accessory|accessories|part|parts|handle|handles|dimension|dimensions|measurements?|specs?|specifications?|sizes?|sizing|height|width|depth|length|weight|diameter|capacity|box|boxes|pack|package|case|count|quantity|quantities|qty|sold as|unit of sale|waterproof|water-resistant|water resistant|water resistance|rating|ratings|latex|latex-free|latex free|material|materials|made of|disposable|reusable|single-use|single use|clean|cleaned|wash|washed|disinfect|disinfected|autoclave|autoclaved|sterilize|sterilized|sterilise|sterilised|colors?|colours?|compatible|compatibilite|compatibilité|dimensions?|mesures?|taille|poids|largeur|longueur|hauteur|prix|couleur|quantit[eé]|vendu comme|tenir|contient|contenir|transporter|réservoir d.oxygène|reservoir d.oxygene|cylindre d.oxygène|cylindre d.oxygene|latex|sans latex|matériau|materiau|jetable|réutilisable|reutilisable|nettoyer|lavable|désinfecter|desinfecter|autoclave|stériliser|steriliser)\b/i.test(text);
}
